"""
Lanzador del UNet en dataset v4_17ch (1m, 17 canales).

Dataset : dataset_v4_17ch
Split   : train=2021-2023 (4241), val=2024 (431), test=2025 (220)
Config  : configs/unet_v4_17ch.yaml
Salidas : results/unet_v4_17ch/
"""
...
MAIN   = ROOT / "main.py"
CFG    = ROOT / "configs/unet_v4_17ch.yaml"
LOG    = ROOT / "results/unet_v4_17ch/run_log.txt"
...
if __name__ == "__main__":
    ...
    banner("UNet v4-17ch  COMPLETADO")
    print(f"  Resultados en: {ROOT / 'results/unet_v4_17ch'}")
